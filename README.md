...
There is also the [browser implementation](https://github.com/delvedor/find-my-way/blob/master/browser.md)!
...
<a name="browser"></a>
## Browser
There is also the browser implementation, check [here](https://github.com/delvedor/find-my-way/blob/master/browser.md)!
