...
test('Match static url with encoding option', t => {
  t.plan(2)
...
test('Match parametric url without encoding option', t => {
  t.plan(2)
...
test('Match encoded parametric url without encoding option', t => {
  t.plan(2)
